...
```
GIVEN a note-taking application x
...
WHEN I enter a new note title and the note’s text x
THEN a Save icon appears in the navigation at the top of the page x
WHEN I click on the Save icon x
THEN the new note I have entered is saved and appears in the left-hand column with the other existing notes x
WHEN I click on an existing note in the list in the left-hand column x
THEN that note appears in the right-hand column x
WHEN I click on the Write icon in the navigation at the top of the page x
